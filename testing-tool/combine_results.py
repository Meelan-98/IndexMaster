...
# Usage example
file1 = 'workloads/results/base_train_workload_0.csv'
file2 = 'workloads/results/reinforced_train_workload_0.csv'
output_file = 'workloads/results/combined_train_workload_0.csv'
